                    ...
                    <CardContent className="pt-6">
                        <div className="flex items-start">
                            ...
                            <div className="w-full">
                                ...
                                <p className="text-sm text-muted-foreground">Pour valider votre sortie nous allons avoir besoin de votre matricule ou de votre identifiant de sortie à 8 chiffres</p>
