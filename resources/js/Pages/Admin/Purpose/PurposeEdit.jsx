...
export default function PurposeEdit({ purpose }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        put(route("admin.purposes.update", purpose.id));
    };
        ...
        <AdminLayout>
            <div className="space-y-6">
                <div className="flex items-center justify-between">
                    <h1 className="text-2xl font-semibold">Modifier le motif de visite</h1>
