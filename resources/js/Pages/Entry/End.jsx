...
const End = () => {
    return (
        <MainLayout sectionName="Bonne visite" SectionIcon={Sparkles} title="Votre visite a bien été enregistrée !" subtitle="N’oubliez pas de venir renseigner votre sortie lors de votre depart">
